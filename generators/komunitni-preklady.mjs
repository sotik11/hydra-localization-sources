...
async function main() {
  ...
  await writeFile(
    join(ROOT, "data", "komunitni-preklady.candidates.json"),
  ...
  console.log(
    `[komunitni-preklady] candidates → nulls=${nulls}, sub-100=${low} (written to data/komunitni-preklady.candidates.json)`
  );
}
